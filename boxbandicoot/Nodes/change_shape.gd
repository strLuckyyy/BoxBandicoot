...
func _ready() -> void:
	...
	@export var _box_obj: Node3D
	@export var _box_material: Material
	@export var _prism_obj: Node3D
	@export var _prism_material: Material
	@export var _sphere_obj: Node3D
	...
	var _box_animation: AnimationPlayer
	var _prism_animation: AnimationPlayer
	var _sphere_aimation: AnimationPlayer


	func _ready() -> void:
		_update_current_mesh()
		_box_animation = $"../CollisionShape3D/Box/AnimationPlayer"
